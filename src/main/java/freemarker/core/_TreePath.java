...
/**
 * <b>Note:</b> This is a copy of the {@link javax.swing.tree.TreePath} class. It
 * is used to make FreeMarker independent from the javax.swing package, so that
 * it can run on the Android platform.
 * 
 ...
 * {@code /tmp/foo/bar} could be represented by a {@code _TreePath} as
 * <pre>new _TreePath(new Object[] {"tmp", "foo", "bar"})</pre>.
 * <p>
 ...
 * @author Philip Milne
 */
public class _TreePath extends Object implements Serializable {
    /** Path representing the parent, null if lastPathComponent represents
     * the root. */
    private _TreePath           parentPath;
    /** Last path component. */
    ...
    public _TreePath(Object[] path) {
        ...
        if(path.length > 1)
            parentPath = new _TreePath(path, path.length - 1);
    }
     ...
     * @see #_TreePath(Object[])
     * @throws IllegalArgumentException if {@code lastPathComponent} is
     *         {@code null}
     */
    public _TreePath(Object lastPathComponent) {
        if(lastPathComponent == null)
     ...
     *         {@code null}
     */
    protected _TreePath(_TreePath parent, Object lastPathComponent) {
        if(lastPathComponent == null)
            throw new IllegalArgumentException("path in TreePath must be non null.");
        parentPath = parent;
        this.lastPathComponent = lastPathComponent;
     ...
     */
    protected _TreePath(Object[] path, int length) {
        ...
        if(length > 1)
            parentPath = new _TreePath(path, length - 1);
    }
    ...
    public Object[] getPath() {
        ...
        for(_TreePath path = this; path != null; path = path.getParentPath()) {
    ...
    public boolean equals(Object o) {
        if(o == this)
            return true;
        if(o instanceof _TreePath) {
            _TreePath            oTreePath = (_TreePath)o;

            if(getPathCount() != oTreePath.getPathCount())
                return false;
            for(_TreePath path = this; path != null;
                    path = path.getParentPath()) {
     ...
     */
    public boolean isDescendant(_TreePath aTreePath) {
        if(aTreePath == this)
            return true;
     ...
     */
    public _TreePath pathByAddingChild(Object child) {
        if(child == null)
            throw new NullPointerException("Null child not allowed");

        return new _TreePath(this, child);
    }
     ...
     */
    public _TreePath getParentPath() {
        return parentPath;
    }
