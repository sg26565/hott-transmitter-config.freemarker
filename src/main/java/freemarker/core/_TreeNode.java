...
/**
 * <b>Note:</b> This is a copy of the {@link javax.swing.tree.TreeNode} class. It
...
public interface _TreeNode {
    /**
     * Returns the child <code>TreeNode</code> at index <code>childIndex</code>.
     */
    _TreeNode getChildAt(final int childIndex);
     ...
     */
    int getIndex(final _TreeNode node);
